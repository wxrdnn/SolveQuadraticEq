...
filesToBuild="main.cxx solve.cxx io.cxx displayCats.cxx interface.cxx errorHandle.cxx utils.cxx debug.cxx test.cxx"

g++ -D _DEBUG -ggdb3 -std=c++17 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat -Wmissing-declarations \
